...
const CRIPTICILLO_PUZZLES = [
  ...
  },
  {
    ...
    pistas: {
      ...
      material: {
        fragmentos: ["acaricia"],
        ayuda: "El material es \"acaricia\" y \"un\". Usaremos un sustituto lígico de uno y otro en su integridad, Le haremos modificaciones según las indicaciones de los indicadores",
      },
      indicadores: {
  ...
  },
  {
    ...
    pistas: {
      ...
      indicadores: {
        fragmentos: ["volvió", "sin", "tras", "una"],
